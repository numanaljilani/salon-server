...
import { cancelAppointment, createAppointment, myappointment, updateAppointment } from "../controllers/appointments/appointmentController";
...
router.put("/cancel-appointments",isAuthenticated ,cancelAppointment); // cancel, update , reject , reschedule 
